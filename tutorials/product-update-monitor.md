...
2. **Forum/Blog site** — with tools like `xenforo_pro.replyToThread` or `xenforo_pro.createThread`
...
3. Expected behavior:
   ...
   - Round 5: Agent calls `xenforo_pro.replyToThread` to publish the update
